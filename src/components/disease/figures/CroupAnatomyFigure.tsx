        ...
        <div className="absolute inset-0 hidden md:block">
          ...
          <div className="absolute left-[5%] top-[42%] w-[27%]">
            ...
            <p className="mt-1 text-sm leading-6 text-slate-600">
              Includes the epiglottis, supraglottis, vocal cords
          ...
          <div className="absolute left-[73%] top-[35%] w-[23%] rounded-2xl border border-blue-200 bg-blue-50/95 p-4 shadow-sm">
            ...
            <p className="mt-1 text-sm leading-6 text-blue-900">
              Region immediately below the vocal cords where narrowing
              is most clinically significant in croup.
            </p>
          </div>
      ...
      <div className="grid gap-4 md:hidden">
        ...
        <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5">
          ...
          <p className="mt-2 leading-7 text-blue-900">
            Region immediately below the vocal cords where narrowing is
            most clinically significant in croup.
          </p>
        </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 md:p-8">
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-rose-200 bg-white p-6">
            <p className="text-center font-bold text-rose-800">
              Croup
            </p>
        ...
        <div className="mt-5 grid gap-6 md:grid-cols-[auto_1fr] md:items-center">
          ...
          <div>
            <h3 className="text-xl font-bold text-amber-950">
              Small decreases in radius can cause large increases in
              airway resistance
            </h3>

            <p className="mt-3 leading-7 text-amber-900">
              The pediatric subglottic airway begins with a relatively
              small diameter. Circumferential edema therefore removes a
